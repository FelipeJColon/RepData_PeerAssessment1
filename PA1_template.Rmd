...
Ch 25, Cambridge University Press. Later, I create a new dataset that is equal to the 
original dataset but with the missing data filled in. I also generate a histogram of the 
total number of steps taken each day. Finally, I calculate and report the mean and median 
total number of steps taken per day. Do these values differ from the estimates from the 
